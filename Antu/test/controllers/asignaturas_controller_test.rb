...
class AsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post asignaturas_url, params: { asignatura: { alumnos: @asignatura.alumnos, profesores: @asignatura.profesores } }, as: :json
    end
  ...
  test "should update asignatura" do
    patch asignatura_url(@asignatura), params: { asignatura: { alumnos: @asignatura.alumnos, profesores: @asignatura.profesores } }, as: :json
    assert_response 200
  end
